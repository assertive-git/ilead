  ...
  <div class="header_inner">
    ...
    <nav class="pc pc_nav">
      <ul class="nav_list">
        ...
        <li><a href="https://www.instagram.com/ilead.company/"><img src="assets/img/insta_icon.png" alt="instaアイコン" width="24" height="24" class="insta"></a></li>
          <li><a href="mypage.php" class="consider_list" type="button">★検討中リスト</a></li>
      </ul>
      
    </nav>
    <a class="sp" href=""><span></span><span></span><span></span></a> </div>
</header>
...
<!--nav class="sp">
  <div class="">
    <ul class="">
      ...
      <li><a href=""><img src="assets/img/insta_icon.png" alt="instaアイコン" width="24" height="24"></a></li>
    </ul>
    <a class="consider_list" href="">★検討中リスト</a> </div>
</nav-->
<!--spメニュー-->