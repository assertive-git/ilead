<div class="max-w-2xl mx-auto lg:px-12 px-4 mt-32 flex flex-col space-y-4">
    ...
    <form class="flex flex-col space-y-6" method="POST" action="/admin/login">
        <div class="flex flex-col space-y-2">
            <label>ユーザー名</label>
            <input type="text" required class="p-2 border border-slate-200" value="<?= set_value('username') ?>" name="username">
        </div>
        <div class="flex flex-col space-y-2">
            <label>パスワード</label>
